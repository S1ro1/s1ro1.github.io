...
I work at 🤗 Hugging Face, where you can mostly find me working on distributed training and inference in [accelerate](https://github.com/huggingface/accelerate) and [transformers](https://github.com/huggingface/transformers). I'm also one of the core maintainers of [Cluster Bot](https://github.com/gpu-mode/discord-cluster-manager).
